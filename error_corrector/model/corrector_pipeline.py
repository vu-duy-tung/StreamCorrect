...
from .corrector_processing import CorrectorProcessor
from .corrector_tokenizer import from_pretrained_text_tokenizer
from .corrector_tokenizer import get_audio_token_id


class CorrectorPipeline(transformers.Pipeline):
    def __init__(
        self,
        ...
        **kwargs
        ...
        self.processor = CorrectorProcessor(
...
transformers.pipelines.PIPELINE_REGISTRY.register_pipeline(
    "corrector-pipeline",
    pipeline_class=CorrectorPipeline,
