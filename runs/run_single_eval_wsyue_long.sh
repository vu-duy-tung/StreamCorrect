...
# Configuration
AUDIO_PATH="${AUDIO_PATH:-/home/duy/PlayWithMino/SimulStreaming/save_dir/data/WSYue-ASR-eval/Long/wav/0000093541.wav}"
REFERENCE_FILE="${REFERENCE_FILE:-/home/duy/PlayWithMino/SimulStreaming/save_dir/data/WSYue-ASR-eval/Long/reference.json}"
