...
OUTPUT_DIR="save_dir/streaming_largev2-05_100_aishell_results_with_ec/"
NUM_FILES=100

# Parallel processing configuration
NUM_WORKERS=6          # Number of parallel workers (set to 1 for sequential processing)
GPUS="0,1,2,3,4,5"         # Comma-separated list of GPU IDs to use

# Error corrector configuration (set USE_ERROR_CORRECTOR=true to enable)
USE_ERROR_CORRECTOR="${USE_ERROR_CORRECTOR:-true}"
ERROR_CORRECTOR_CKPT="${ERROR_CORRECTOR_CKPT:-SpeechLMCorrector/ultravox_lora_continued_more_erroneous_5/checkpoint-2895}"
